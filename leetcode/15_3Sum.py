        ...
        for index in range(len(integers)):
            ...
            while left < right:
                if integers[left] + integers[right] < 0 - integers[index]:
                    ...
                    result.append([integers[index], integers[left], integers[right]]) # After a triplet is appended, we try our best to increase the numeric value of its first element or that of its second.
